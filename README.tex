...
\item
  RDD generalised estimation: allows to use custom estimating functions
  to get the RDD coefficient. Could allow for example a probit RDD, or
  quantile regression.
\item
...
\item
  ...
  either using a cluster covariance matrix ( \textbf{vcovCluster()} ) or
